...
sized by the owner's band — eight to sixteen work commits, one branch
that accumulates the session's work until it is there, never a PR per
topic ("small" stood here until 2026-09-19 and produced exactly that);
