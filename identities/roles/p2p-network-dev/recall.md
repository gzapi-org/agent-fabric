...
class: recall
description: "Where p2p-network-dev's knowledge lives — charter, remit, distilled slices, this agent's memory — and how to trace a claim to its sources."
tier: 2
...
- **The charter** (`identities/roles/p2p-network-dev/charter.md`, here) — what the
  function is. The project's remit for it
  (`<working copy>/.agent-fabric/roles/p2p-network-dev.md`) — what the function
  covers in that repository.
- **The distilled slices** — `memory/domains/p2p-network-dev/` here for the field,
  `<working copy>/.agent-fabric/memory/p2p-network-dev/` in the project for the
