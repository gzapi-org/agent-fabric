#!/usr/bin/env bash
# gzapp's forwarder to the fabric's runtime/github/post-substitute-review.sh — the one place
...
# gzapp's tools/gh/post-substitute-review.sh forwards here, argv and stdin untouched.
#
...
exec bash "$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../.." && pwd)/runtime/github/post-substitute-review.sh" "$@"
