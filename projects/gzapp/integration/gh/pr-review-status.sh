#!/usr/bin/env bash
# gzapp's forwarder to the fabric's runtime/github/pr-review-status.sh — the one place
...
exec bash "$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../.." && pwd)/runtime/github/pr-review-status.sh" "$@"
