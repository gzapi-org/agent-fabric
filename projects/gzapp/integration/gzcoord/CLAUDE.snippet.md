...
- as `ROLE`, the slug of the role you hold (your launch prompt says it; `identities/roles/catalog.json`) — `backend-dev`, never a title; `fabric-whoami --json` reports your address, role and project;
