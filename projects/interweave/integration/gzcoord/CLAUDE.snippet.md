...
- as `ROLE`, the slug of the role you hold (your launch prompt says it; `identities/roles/catalog.json`) — `p2p-network-dev`, never a title; `../agent-fabric/bin/fabric-whoami --json` reports your address, role and project;
